...
-- // Game Load Check // -- @55xud on discord
if not game:IsLoaded() then
    game.Loaded:Wait()
end

-- // Clear FOV Parts // -- @55xud on discord
...
-- // Check if Part in Fov and Visible // -- @55xud on discord
...
-- // Get Closest Hit Point on Part // -- @55xud on discord
...
-- // Get Closest Hit Point on Base Part // -- @55xud on discord
...
-- // Get Velocity Function // -- @55xud on discord
...
-- // Get Closest Player // -- @55xud on discord
...
-- // Convert Keybind to KeyCode // -- @55xud on discord
...
-- // Hook Tool Activation // -- @55xud on discord
...
-- // Initial Notification // -- @55xud on discord
sendNotification("dc.gg/flowerz", "♣️ #1 Triggerbot")
wait(3)
sendNotification("dc.gg/flowerz", "♣️ Supports Solara")
